...
const works = [
  ...
  },
  {
    ...
    projectClient: 'Posts and comments',
    projectRole: 'Back End Dev',
    projectYear: '2022',
  ...
  {
    projectTitle: 'rails-back-end',
    projectClient: 'Ruby on Rails',
    projectRole: 'Back End Dev',
    projectYear: '2022',
    projectSnapshotDesktop: './images/desk-works3.png',
    projectSnapshotMobile: './images/works3.png',
    projectDescription:
      'We can create a simple app that uses both React and Rails. However, the beauty of the distinction between the frontend UI and backend API is that they can be two independent apps. Thanks to that the maintenance of the project is easier - frontend and backend teams can manage their own repos. Also, in the future changing the tech stack for either the frontend or backend part is easier.',
    projectTechnologies: ['html', 'css', 'ruby', 'ruby on rails'],
    livelink: 'https://github.com/OybekKayumov/hello-rails-back-end',
    sourcelink: 'https://github.com/OybekKayumov/hello-rails-back-end',
  },
  {
    projectTitle: 'react-front-end',
    projectClient: 'React - Redux',
    projectRole: 'Front End Dev',
    projectYear: '2022',
    projectSnapshotDesktop: './images/desk-works4.png',
    projectSnapshotMobile: './images/works4.png',
    projectDescription:
      'We can create a simple app that uses both React and Rails. However, the beauty of the distinction between the frontend UI and backend API is that they can be two independent apps. Thanks to that the maintenance of the project is easier - frontend and backend teams can manage their own repos. Also, in the future changing the tech stack for either the frontend or backend part is easier.',
    projectTechnologies: ['html', 'css', 'react', 'redux'],
    livelink: 'https://github.com/OybekKayumov/hello-react-front-end',
    sourcelink: 'https://github.com/OybekKayumov/hello-react-front-end',
  },
];
